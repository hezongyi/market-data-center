...
- feature-flag cutover receipt `d186aa7edfc642b8baba36a9371457f7` 和 rollback receipt `8771c2a0f91a497394864cab918bf289` 分别为 `pass`，均绑定 Data Center deployment 与 consumer commit `aa7aa8751b7d75db8d196b03262967e790a9c205`；未迁移 inventory 明确记录 68,331,636 条、5,853,971,477 bytes raw-only 数据且 `bulk_migration_allowed=false`。
