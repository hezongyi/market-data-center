...
- The 2026-09-16 dataset-centered amendment is `docs/specs/2026-09-16-dataset-centered-eurusd-maintenance.md`; read it and `CONTEXT.md` with the original baseline. Next is P2.1: one Dukascopy FX BID 1m dataset and EURUSD. Independent dataset directories, one base granularity, pause allowing manual maintenance, and archive denying data queries are required. Other assets/providers, tick, raw daily, and adjustment features remain out of scope.
